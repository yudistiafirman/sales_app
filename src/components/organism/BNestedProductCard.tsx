	...
	const getDataToDisplay = () => {
		...
		if (item?.Product) {
			if (item?.Product?.category?.parent) {
				displayName = `${item?.Product?.category?.parent
			...
			displayName = `${item?.RequestedProduct?.Product?.category?.Parent
					? item?.RequestedProduct?.Product?.category?.Parent?.name + ' '
					: ''
				}${item?.RequestedProduct?.displayName} ${item?.RequestedProduct?.Product?.category
			...
			displayName = `${item?.PoProduct?.RequestedProduct?.Product?.category?.Parent
					? item?.PoProduct?.RequestedProduct?.Product?.category?.Parent?.name +
					' '
					: ''
				}${item?.PoProduct?.RequestedProduct?.displayName} ${item?.PoProduct?.RequestedProduct?.Product?.category
			...
			displayName = `${item?.PoProduct?.RequestedProduct?.Product?.category?.parent
					...
					' '
					: ''
				}${item?.PoProduct?.RequestedProduct?.Product?.displayName} ${item?.PoProduct?.RequestedProduct?.Product?.category
					? item?.PoProduct?.RequestedProduct?.Product?.category?.name
					: ''
				}`;
			offeringPrice = item?.PoProduct?.RequestedProduct?.offeringPrice;
