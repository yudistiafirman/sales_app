...
export default function LastStepPopUp({
    ...
    const [lastStepPicked, setLastStepPicked] =
        useState<LastStepPickedType>("");
    ...
    const inputs: Input[] = [
        {
            ...
            dropdown: {
                items: [
                    {
                        label: "Sudah MOU dengan Kompetitor",
                        value: "MOU_COMPETITOR"
                    },
                    {
                        label: "Proyek sudah selesai dibangun",
                        value: "FINISHED"
                    }
                ],
