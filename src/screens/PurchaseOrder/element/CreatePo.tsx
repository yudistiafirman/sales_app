...
function CreatePo() {
  ...
  const { poImages, choosenSphDataFromModal, openCamera, poNumber, customerType } =
  ...
  }, [dispatch, goToCamera, navRoutes.params, openCamera, poState.currentState]);
  ...
  const renderCustomButton = () => (
    <BTouchableText onPress={() => dispatch({ type: 'searchingSph' })} title="Ganti" />
  );
