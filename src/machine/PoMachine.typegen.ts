...
export interface Typegen0 {
  ...
  eventsCausingServices: {
    ...
    'postPo': 'done.invoke.purchase order.PostPurchaseOrder.postFiles:invocation[0]' | 'done.invoke.purchase order.PostPurchaseOrder.postImages:invocation[0]' | 'goToPostPo' | 'retryPostPurchaseOrder';
    'uploadFiles': 'done.invoke.purchase order.PostPurchaseOrder.postImages:invocation[0]' | 'goToPostPo';
    'uploadPhoto': 'goToPostPo';
  };
  matchesStates: 'PostPurchaseOrder' | 'PostPurchaseOrder.failCreatedPo' | 'PostPurchaseOrder.postFiles' | 'PostPurchaseOrder.postImages' | 'PostPurchaseOrder.postPoPayload' | 'PostPurchaseOrder.successCreatedPo' | 'SecondStep' | 'SecondStep.SphDocumentLoaded' | 'SecondStep.errorGettingDocuments' | 'SecondStep.gettingSphDocuments' | 'SecondStep.idle' | 'ThirdStep' | 'ThirdStep.idle' | 'checkSavedPo' | 'enquirePoType' | 'firstStep' | 'firstStep.SearchSph' | 'firstStep.addPO' | 'hasSavedPo' | 'openCamera' | { 'PostPurchaseOrder'?: 'failCreatedPo' | 'postFiles' | 'postImages' | 'postPoPayload' | 'successCreatedPo';
