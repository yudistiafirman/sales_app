  ...
  export interface Typegen0 {
        '@@xstate/typegen': true;
        internalEvents: {
          "done.invoke.transaction machine.getTransaction.loadingTransaction:invocation[0]": { type: "done.invoke.transaction machine.getTransaction.loadingTransaction:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.transaction machine.getTransaction.typeLoaded.getTransactionsBaseOnType:invocation[0]": { type: "done.invoke.transaction machine.getTransaction.typeLoaded.getTransactionsBaseOnType:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"error.platform.transaction machine.getTransaction.loadingTransaction:invocation[0]": { type: "error.platform.transaction machine.getTransaction.loadingTransaction:invocation[0]"; data: unknown };
"error.platform.transaction machine.getTransaction.typeLoaded.getTransactionsBaseOnType:invocation[0]": { type: "error.platform.transaction machine.getTransaction.typeLoaded.getTransactionsBaseOnType:invocation[0]"; data: unknown };
