...
export interface Typegen0 {
  ...
  internalEvents: {
    ...
    'xstate.after(100)#search area.searchLocation.searchValueLoaded': { type: 'xstate.after(100)#search area.searchLocation.searchValueLoaded' };
  ...
  eventsCausingServices: {
    ...
    'getLocationBySearch': 'retryGettingLocation' | 'xstate.after(100)#search area.searchLocation.searchValueLoaded';
    'gettingPlacesId': 'onGettingPlacesId';
  };
  matchesStates: 'getLocation' | 'getLocation.allowed' | 'getLocation.currentLocationLoaded' | 'getLocation.finito' | 'searchLocation' | 'searchLocation.errorGettingLocationData' | 'searchLocation.gettingPlaceId' | 'searchLocation.inputting' | 'searchLocation.onGettingLocation' | 'searchLocation.searchValueLoaded' | { 'getLocation'?: 'allowed' | 'currentLocationLoaded' | 'finito';
    'searchLocation'?: 'errorGettingLocationData' | 'gettingPlaceId' | 'inputting' | 'onGettingLocation' | 'searchValueLoaded'; };
  tags: never;
}
