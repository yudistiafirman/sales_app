...
export interface Typegen0 {
  '@@xstate/typegen': true;
  internalEvents: {
    'done.invoke.price machine.getLocation.allowed:invocation[0]': {
      type: 'done.invoke.price machine.getLocation.allowed:invocation[0]';
      data: unknown;
...
'getProducts': 'done.invoke.price machine.getProduct.loadingProduct:invocation[0]' | 'onChangeCategories' | 'onEndReached' | 'refreshingList';
  ...
  matchesStates:
    ...
    | 'getLocation'
    | 'getLocation.allowed'
    | 'getLocation.askPermission'
    | 'getLocation.currentLocationLoaded'
    | 'getLocation.denied'
    | 'getLocation.denied.background'
    | 'getLocation.denied.foreground'
    | 'getLocation.errorGettingLocation'
    | 'getLocation.finito'
    | 'getLocation.locationDetailLoaded'
    ...
    | {
        Tnc?: 'agreementHiding' | 'agreementShowed';
