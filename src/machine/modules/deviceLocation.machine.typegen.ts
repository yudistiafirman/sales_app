...
export interface Typegen0 {
  '@@xstate/typegen': true;
  internalEvents: {
    'done.invoke.deviceLocation.allowed:invocation[0]': { type: 'done.invoke.deviceLocation.allowed:invocation[0]'; data: unknown; __tip: 'See the XState TS docs to learn how to strongly type this.' };
    'done.invoke.deviceLocation.askPermission:invocation[0]': { type: 'done.invoke.deviceLocation.askPermission:invocation[0]'; data: unknown; __tip: 'See the XState TS docs to learn how to strongly type this.' };
    'error.platform.deviceLocation.allowed:invocation[0]': { type: 'error.platform.deviceLocation.allowed:invocation[0]'; data: unknown };
