...
export interface Typegen0 {
    "@@xstate/typegen": true;
    internalEvents: {
        "done.invoke.search product.categoriesLoaded.gettingProducts:invocation[0]": {
            type: "done.invoke.search product.categoriesLoaded.gettingProducts:invocation[0]";
            data: unknown;
            __tip: "See the XState TS docs to learn how to strongly type this.";
        };
        "done.invoke.search product.searching:invocation[0]": {
            type: "done.invoke.search product.searching:invocation[0]";
            data: unknown;
            __tip: "See the XState TS docs to learn how to strongly type this.";
        };
        "error.platform.search product.categoriesLoaded.gettingProducts:invocation[0]": {
            type: "error.platform.search product.categoriesLoaded.gettingProducts:invocation[0]";
            data: unknown;
        };
        "error.platform.search product.searching:invocation[0]": {
            type: "error.platform.search product.searching:invocation[0]";
            data: unknown;
        };
