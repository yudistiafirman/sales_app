...
"error.platform.visit history machine.getVisitationByProjectId:invocation[0]": { type: "error.platform.visit history machine.getVisitationByProjectId:invocation[0]"; data: unknown };
...
"sliceVisitationData": "onChangeVisitationIdx";
        ...
        matchesStates: "errorGettingData" | "getVisitationByProjectId" | "idle" | "visitationDataLoaded";
        tags: never;
      }
