...
export interface Typegen0 {
  '@@xstate/typegen': true;
  internalEvents: {
    'done.invoke.search PO.categoriesLoaded.gettingPO:invocation[0]': {
      type: 'done.invoke.search PO.categoriesLoaded.gettingPO:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'done.invoke.search PO.searching:invocation[0]': {
      type: 'done.invoke.search PO.searching:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
