...
export const getAllVisitationOrders = async (page?: string, size?: string) =>
  customRequest(BrikApiOrder.getAllVisitationOrders(page, size), 'GET', undefined, true);
...
export const getPurchaseOrderByID = async (id: string) =>
  customRequest(BrikApiOrder.getPurchaseOrderByID(id), 'GET', undefined, true);
...
export const getAllDeliveryOrders = async (
  ...
  size?: string,
  page?: string
) => customRequest(BrikApiOrder.deliveryOrder(status, page, size), 'GET', undefined, true);
...
export const getVisitationOrderByID = async (id: string) =>
  customRequest(BrikApiOrder.getVisitationOrderByID(id), 'GET', undefined, true);

export const postSph = async (payload: sphOrderPayloadType) =>
  customRequest(BrikApiOrder.orderSphPost(), 'POST', payload, true);

export const getSphByProject = async (searchQuery: string, customerType: 'INDIVIDU' | 'COMPANY') =>
  customRequest(BrikApiOrder.getSphByProject(searchQuery, customerType), 'GET', undefined, true);
...
export const updateDeliveryOrder = async (payload: updateDeliverOrder, deliveryOrderId: string) =>
  customRequest(BrikApiOrder.deliveryOrderByID(deliveryOrderId), 'PUT', payload, true);
...
) => customRequest(BrikApiOrder.deliveryOrderWeightByID(deliveryOrderId), 'PUT', payload, true);
