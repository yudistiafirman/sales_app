...
export const getTransactionTab = async () => customRequest(BrikApiOrder.transactionTab(), 'GET', undefined, true);

export const getAllVisitationOrders = async (page?: string, size?: string) => customRequest(
...
export const getPurchaseOrderByID = async (id: string) => customRequest(
...
export const getAllDeposits = async (page?: string, size?: string) => customRequest(
...
export const getDepositByID = async (id: string) => customRequest(BrikApiOrder.getDepositByID(id), 'GET', undefined, true);

export const getAllSchedules = async (page?: string, size?: string) => customRequest(
...
export const getScheduleByID = async (id: string) => customRequest(
...
export const getDeliveryOrderByID = async (id: string) => customRequest(
...
export const getVisitationOrderByID = async (id: string) => customRequest(
...
export const postSph = async (payload: sphOrderPayloadType) => customRequest(BrikApiOrder.orderSphPost(), 'POST', payload, true);
...
export const getCreatedSphDocuments = async (id: string) => customRequest(
...
export const postPurchaseOrder = async (payload) => customRequest(BrikApiOrder.purchaseOrder(), 'POST', payload, true);

export const postDeposit = async (payload) => customRequest(BrikApiOrder.postDeposit(), 'POST', payload, true);

export const postSchedule = async (payload) => customRequest(BrikApiOrder.postSchedule(), 'POST', payload, true);
