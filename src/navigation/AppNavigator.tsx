...
function RootScreen(userData: UserModel.DataSuccessLogin | null, isSignout: boolean) {
  if (userData !== null) {
...
function AppNavigator() {
  const { isLoading, userData, isSignout, isNetworkLoggerVisible, isShowButtonNetwork } =
    useAsyncConfigSetup();
